// pages/DailyRewardsForm.js - Daily Rewards Campaign Form (Add/Edit)
...
const DailyRewardsForm = ({ isEdit = false }) => {
  ...
  const fetchCampaign = async () => {
    ...
    try {
      ...
      setFormData({
        campaign_type: campaign.campaign_type || 'daily',
          ...
          <div style={{
            ...
            <div style={{fontSize: '0.875rem', color: 'var(--text-secondary)', lineHeight: '1.6'}}>
              <p>
                ...
                ({formData.campaign_type} campaign, {formData.is_active ? 'Active' : 'Inactive'})
              </p>
              <p>
